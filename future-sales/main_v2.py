...
df_sales_with_category = pandas.merge(left=df_sales, right=df_item, on='item_id', how='left')

sales_group = df_sales_with_category.groupby(['shop_id', 'date_block_num', 'item_category_id'])
