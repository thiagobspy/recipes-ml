...
'''
Com camada entrada, saida e oculta
'''
# create dataset
...
def initialize_with_zeros(var, next_n):
    w = numpy.zeros((var, next_n))
    b = numpy.zeros((1, next_n))

    assert (w.shape == (var, next_n))
    assert (b.shape == (1, next_n))
